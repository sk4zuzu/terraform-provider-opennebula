		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.1.size", "15"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.1.ip4", "172.16.100.170"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.2.ar_type", "IP4"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.2.size", "12"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.2.ip4", "172.16.100.130"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.0.ar_type", "IP4"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.0.size", "15"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.0.ip4", "172.16.100.170"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.1.ar_type", "IP4"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.1.size", "17"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.1.ip4", "172.16.100.110"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.2.ar_type", "IP4"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.2.size", "13"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.2.ip4", "172.16.100.140"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.3.ar_type", "IP6"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "ar.3.size", "2"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "hold_ips.#", "2"),
					resource.TestCheckResourceAttr("opennebula_virtual_network.test", "hold_ips.0", "172.16.100.112"),
